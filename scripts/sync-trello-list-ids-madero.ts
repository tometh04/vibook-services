#!/usr/bin/env tsx
/**
 * Script para sincronizar trello_list_id de todos los leads de Madero
...
async function syncListIds() {
  console.log("🔄 SINCRONIZANDO trello_list_id DE TODOS LOS LEADS - MADERO")
  ...
  console.log("")
  console.log("=".repeat(60))
  console.log("✅ SINCRONIZACIÓN COMPLETADA - MADERO")
  console.log("=".repeat(60))
