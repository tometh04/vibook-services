#!/usr/bin/env tsx
/**
 * Script para arreglar el webhook de Trello
...
async function fixWebhook() {
  console.log("🔧 ARREGLANDO WEBHOOK DE TRELLO")
  ...
  // 5. Eliminar webhooks incorrectos o duplicados
  console.log("")
  ...
  // 6. Verificar si ya existe un webhook correcto
  ...
  const newWebhookResponse = await fetch("https://api.trello.com/1/webhooks/", {
    ...
    body: JSON.stringify({
      description: `MAXEVA GESTION - ${board.name}`,
