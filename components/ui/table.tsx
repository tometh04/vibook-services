...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={cn("[&_tr]:border-t [&_tr]:border-gray-200 [&_tr:first-child]:border-t-0", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-4 text-left align-middle text-xs font-semibold text-gray-500 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
